...
import ModalUploadAvatar from "../components/userProfile/ModalUploadAvatar"
import UserOtherInfo from "../components/userProfile/UserOtherInfo"
...
interface IWidgetUserProfileProps {
...
const WidgetUserProfile = (props: IWidgetUserProfileProps) => {
  const { userProfile, row = 0 } = props
  ...
  return userInfo ? (
    <>
      <Stack
        className={classes.userInfoWidget}
        style={{
...
export default connect(mapStateToProps, null)(WidgetUserProfile)
