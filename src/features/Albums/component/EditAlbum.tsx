...
import { InputWidgetField, CheckBoxField , DescriptionField, PictureFieldV2 } from "@/components/Form"
...
export const EditAlbum = ({ categories, form }: IAddAlbum) => {
  return (
    <AddAlbumWrapper>
      <InputWidgetField
        form={form}
      ...
      <PictureFieldV2
        ...
        disabled={false}
        initPreviewImg={form.getValues('thumbnailImage')}
        required
      />
      <CheckBoxField
        form={form as any}
